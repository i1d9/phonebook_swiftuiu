...
struct ContactController {
    ...
    static var preview: ContactController = {
        let result = ContactController(inMemory: true)
        let viewContext = result.container.viewContext
        for _ in 0..<10 {
            ...
            person.first_name = firstNames.randomElement()!
            person.second_name = lastNames.randomElement()!
